...
"""
Django settings for snowboarding_paradise project.
...
SECRET_KEY = '*1)t17kdej^acpe)rt$gysf^ywmu0-6&)ye*1_sdv7_!=7v!lj'
...
ROOT_URLCONF = 'snowboarding_paradise.urls'
...
WSGI_APPLICATION = 'snowboarding_paradise.wsgi.application'
